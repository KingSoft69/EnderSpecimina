...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if(mixinClassName.contains(".mods.")) {
            ...
            String modIdAlternate = modId.replace("_", "-"); // Packages can't have "-"'s, so allow to use "_" instead
            ...
            return FabricLoader.getInstance().isModLoaded(modId) || FabricLoader.getInstance().isModLoaded(modIdAlternate);
        }
        return true;
    }
